...
public class SpaceServiceItemAdapter extends
        RecyclerView.Adapter<SpaceServiceItemAdapter.ViewHolder> {

    private LayoutInflater mInflater;
    private List<SpaceDetailBean.ResultsBean.ServiceListBean> mDatas;

    public SpaceServiceItemAdapter(Context context, List<SpaceDetailBean.ResultsBean.ServiceListBean> datats) {

...
import com.uban.rent.ui.view.progress.MaterialProgressBar;
...
public class GetMoreListView extends ListView {
    ...
    // 加载更多忙碌框
    private MaterialProgressBar pbFootRefreshing;
    ...
    private void init(Context context, AttributeSet attrs) {
         ...
         * 底部
         */
        footView = inflater.inflate(R.layout.view_more_list_view_foot, this, false);
        tvFootTitle = (TextView) footView.findViewById(R.id.tv_foot_title);
        pbFootRefreshing = (MaterialProgressBar) footView.findViewById(R.id.pb_foot_refreshing);
    ...
    private void getMore() {
        if (getMoreListener != null) {
            ...
            tvFootTitle.setVisibility(View.VISIBLE);
            tvFootTitle.setText("正在载入...");
    ...
    public void getMoreComplete() {
        ...
        tvFootTitle.setVisibility(View.GONE);
    }

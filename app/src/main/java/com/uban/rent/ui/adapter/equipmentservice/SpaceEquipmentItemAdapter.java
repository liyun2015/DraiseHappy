...
public class SpaceEquipmentItemAdapter extends
        RecyclerView.Adapter<SpaceEquipmentItemAdapter.ViewHolder> {

    private LayoutInflater mInflater;
    private List<SpaceDetailBean.ResultsBean.EquipmentListBean> mDatas;

    public SpaceEquipmentItemAdapter(Context context, List<SpaceDetailBean.ResultsBean.EquipmentListBean> datats) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(SpaceDetailBean.ResultsBean.EquipmentListBean serviceListBean) {

...
public class Constants {
    ...
    public static final String NOTIFY_URL = "http://idfa.dev.uban.com/ubanpay/notify.html";//支付回调地址
    ...
    public static final String MEMBER_EQUIPMENT_QRCODE = "http://m.uban.com/bj/vipRecord/%s.html";
